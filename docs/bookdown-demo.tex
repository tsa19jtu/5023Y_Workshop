...
When typed in-line within a section of what would otherwise be Markdown text, it knows to produce an r output instead 2021-10-31
...
\textbf{h.} Read in the disease\_burden.csv data
...
\textbf{o} Let's do one more cool and fun thing! And make an interactive version of our plot - just for fun!
...
\section{Further Reading, Guides and tips}\label{further-reading-guides-and-tips-2}}
