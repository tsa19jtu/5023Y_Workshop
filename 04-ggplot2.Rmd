...
A complementary approach is to set the *shape* of your geoms according to categorical variables. 
...
penguins %>% 
  ggplot(aes(x=flipper_length_mm, 
             y = body_mass_g))+
  geom_point(aes(colour=species,
                 shape=species))+ # as with colours we could set these to specific values if we want
  scale_color_manual(values=penguin_colours)+
  theme_minimal()
